...
class MovieRpository extends GetxController {
  ...
  Future<List<Movie>> recuperarFilmePopulares([int pag = 1]) async {
    ...
    List<Movie> lisFilmes  = await serviceMovie.getListMovieApi(uriFilmesPopulares, _pagFilmesPopulares);
    return lisFilmes;
  ...
  Future<List<Movie>> recuperarFilmesMaisVistos([int pag = 1]) async {
    ...
    List<Movie> lisFilmes  =  await serviceMovie.getListMovieApi(uriTopRated,_pagFilmesTopRatep);
    return lisFilmes;
  }
